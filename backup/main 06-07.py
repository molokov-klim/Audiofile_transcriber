...
from PyQt5.QtWidgets import (QMainWindow, QTextEdit, QAction, QFileDialog, QApplication, QInputDialog)
from PyQt5.QtGui import QImage, QTextCursor, QTextDocument, QTextCharFormat, QBrush, QColor
...
class Ui(QtWidgets.QMainWindow, Form):
    ...
    def test(self):
        print("start")
        text = QFileDialog.getOpenFileName(QtWidgets.QMainWindow(), 'Open file', '/')[0]
